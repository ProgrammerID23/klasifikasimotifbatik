...
# Set page config
st.set_page_config(
    page_title="Batik Pattern Classifier",
    page_icon="🎨",
    layout="wide",
...
CLASS_NAMES = [
    ...
    'Batik Lasem', 'Batik Megamendung', 'Batik Pala', 'Batik Parang', 'Batik Poleng',
...
def load_models():
    ...
    cnn_model_id = "1T2UTcSsh5iZIzyzqFaxymiPdVus3CpVk"
    resnet_model_id = "1G0DTe0plm69HUXovk2dRGjK9RUibL1k9"
...
def main():
    st.title("🎨 Batik Pattern Classification")
    st.write("Upload batik images to classify their patterns using CNN and ResNet models")
                ...
                for idx, file in enumerate(uploaded_files):
                    ...
                    if use_cnn and use_resnet:
                        if cnn_class_idx == resnet_class_idx:
                            ...
                            st.warning("⚠️ Models have different predictions. Consider reviewing the image.")
